...
public class LogbookController implements LogbookApi {
	...
	@Override
	public ResponseEntity<LogbookEntryPage> getLogbookEntries(OffsetDateTime from, OffsetDateTime to, String q,
			TransportMode transportMode, Integer page, Integer size) {
	...
	@Override
	public ResponseEntity<LogbookEntry> updateLogbookEntry(UUID entryId,
			UpdateLogbookEntryRequest updateLogbookEntryRequest) {
