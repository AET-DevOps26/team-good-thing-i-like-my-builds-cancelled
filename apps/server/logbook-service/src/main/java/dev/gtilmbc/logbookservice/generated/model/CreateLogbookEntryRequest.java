...
public class CreateLogbookEntryRequest {
  ...
  public CreateLogbookEntryRequest() {
    super();
  }
   ...
   */
  public CreateLogbookEntryRequest(String title, OffsetDateTime startTime, OffsetDateTime endTime, String startCity, String destinationCity, TransportMode transportMode) {
    this.title = title;
  ...
  public CreateLogbookEntryRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  public CreateLogbookEntryRequest description(@Nullable String description) {
  ...
  public CreateLogbookEntryRequest startTime(OffsetDateTime startTime) {
    this.startTime = startTime;
    return this;
  }
  ...
  public CreateLogbookEntryRequest endTime(OffsetDateTime endTime) {
    this.endTime = endTime;
    return this;
  }
  ...
  public CreateLogbookEntryRequest startCity(String startCity) {
    this.startCity = startCity;
    return this;
  }
  ...
  public CreateLogbookEntryRequest destinationCity(String destinationCity) {
    this.destinationCity = destinationCity;
    return this;
  }
  ...
  public CreateLogbookEntryRequest startStationId(@Nullable String startStationId) {
  ...
  public CreateLogbookEntryRequest destinationStationId(@Nullable String destinationStationId) {
  ...
  public CreateLogbookEntryRequest transportMode(TransportMode transportMode) {
    this.transportMode = transportMode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateLogbookEntryRequest createLogbookEntryRequest = (CreateLogbookEntryRequest) o;
    return Objects.equals(this.title, createLogbookEntryRequest.title) &&
        Objects.equals(this.description, createLogbookEntryRequest.description) &&
        Objects.equals(this.startTime, createLogbookEntryRequest.startTime) &&
        Objects.equals(this.endTime, createLogbookEntryRequest.endTime) &&
        Objects.equals(this.startCity, createLogbookEntryRequest.startCity) &&
        Objects.equals(this.destinationCity, createLogbookEntryRequest.destinationCity) &&
        Objects.equals(this.startStationId, createLogbookEntryRequest.startStationId) &&
        Objects.equals(this.destinationStationId, createLogbookEntryRequest.destinationStationId) &&
        Objects.equals(this.transportMode, createLogbookEntryRequest.transportMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLogbookEntryRequest {\n");
