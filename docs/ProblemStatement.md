...
The Travel Journal Application will support multiple key features:
- Users can Keep Track of their trips. The following information will be stored for each trip:
...
- Users can plan their train journeys for their trips. This may include:
  - How can I get to my destination fastest?
  - How can I get to my destination cheapest?
  - How can I get to my destination with the least amount of transfers?
  - How can I get to my final destination with interesting places for transfers?
...
The intended users of the Travel Journal Application are private individuals who enjoy traveling and want to keep track 
of their trips, discover new destinations, and gain insights into their travel habits. A certain liking for trains and 
statistics may be a common trait among the users, but it is not a requirement.
...
delay rate than other lines. Alice decides to plan her next trip using a different train line, and finds a route that 
